...
class WorkforceJobCancelAssignmentView(APIView):
    ...
    def post(self, request, pk):
        ...
        with transaction.atomic():
            ...
            # Clean up unverified PreServiceVerification for this assignment
            PreServiceVerification.objects.filter(job=job_obj, otp_verified=False).delete()
...
class WorkforceJobTechnicianCancelView(APIView):
    ...
    def post(self, request, pk):
        ...
        with transaction.atomic():
            ...
            # Clean up unverified PreServiceVerification
            PreServiceVerification.objects.filter(job=job, otp_verified=False).delete()
