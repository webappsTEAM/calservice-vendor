...
ALLOWED_TRANSITIONS = {
    "draft": ["new_request", "confirmed", "requested", "offering", "dispatching", "assigned", "unassigned", "cancelled"],
    "new_request": ["confirmed", "requested", "offering", "dispatching", "assigned", "unassigned", "cancelled"],
    "requested": ["new_request", "confirmed", "vendor_confirmed", "offering", "dispatching", "assigned", "technician_assigned", "unassigned", "accepted", "cancelled"],
    ...
    "vendor_confirmed": ["assigned", "technician_assigned", "accepted", "on_the_way", "technician_on_the_way", "cancelled"],
    "assigned": ["received", "accepted", "reassigned", "redispatching", "on_the_way", "technician_on_the_way", "cancelled"],
    "technician_assigned": ["accepted", "on_the_way", "en_route", "technician_on_the_way", "arrived", "technician_arrived", "reassigned", "cancelled"],
    "received": ["accepted", "reassigned", "redispatching", "cancelled"],
    "accepted": ["on_the_way", "en_route", "technician_on_the_way", "arrived", "technician_arrived", "redispatching", "cancelled", "unable_to_complete"],
    "on_the_way": ["arrived", "technician_arrived", "redispatching", "cancelled", "unable_to_complete"],
    "en_route": ["arrived", "technician_arrived", "redispatching", "cancelled", "unable_to_complete"],
    "technician_on_the_way": ["arrived", "technician_arrived", "inspection_in_progress", "cancelled"],
    "arrived": ["service_started", "in_progress", "inspection_in_progress", "cancelled", "unable_to_complete"],
    "technician_arrived": ["inspection_in_progress", "service_started", "in_progress", "cancelled"],
    "inspection_in_progress": ["inspection_completed", "quotation_sent", "customer_approved", "cancelled"],
    "inspection_completed": ["quotation_sent", "customer_approved", "converted_to_job", "cancelled"],
    "quotation_sent": ["customer_approved", "inspection_in_progress", "cancelled"],
    "customer_approved": ["converted_to_job", "in_progress", "service_started", "cancelled"],
    "converted_to_job": ["in_progress", "service_started", "proof_submitted", "completed", "cancelled"],
    "service_started": ["in_progress", "cancelled", "unable_to_complete"],
    "in_progress": ["proof_submitted", "completed", "cancelled", "unable_to_complete", "follow_up_required"],
