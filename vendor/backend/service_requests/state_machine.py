...
ALLOWED_TRANSITIONS = {
    ...
    "assigned": ["received", "accepted", "on_the_way", "en_route", "reassigned", "redispatching", "cancelled"],
    "received": ["accepted", "on_the_way", "en_route", "reassigned", "redispatching", "cancelled"],
